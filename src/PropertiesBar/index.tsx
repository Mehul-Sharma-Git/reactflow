...
const PropertiesBar = () => {
    ...
    const onChange = useCallback((e: any) => {
        ...
        setSelectedNode((sn:any)=>({...sn, data:{...sn.data, [e.target.name]: e.target.value}}))

    }, [selectedNode])
    const saveToState = useCallback((e:any) =>{
    ...
    return (
        selectedNode ?
                ...
                <div className="">
                    {
                        Object.entries(selectedNode.data).map((d: any) => {
                            ...
                            return <> <div>
                                ...
                                <input name={d[0]} onChange={onChange} value={d[1]} /></>
                        })
                    }
                    {/* <label>label:</label>
            ...
            </aside> : <aside className='sliding-bar'></aside>
    )
};
